...
public class Graduacao {
    ...
    public static String getGraducao(int idGraducao) {
        ...
        } else if (vila.equals(Vilas.AREIA)) {
            switch (idGraducao) {
                case 0:
                    return "Estudante";
                case 1:
        ...
        } else if (vila.equals(Vilas.NEVOA)) {
            switch (idGraducao) {
                case 0:
                    return "Estudante";
                case 1:
        ...
        } else if (vila.equals(Vilas.PEDRA)) {
            switch (idGraducao) {
                case 0:
                    return "Estudante";
                case 1:
        ...
        } else if (vila.equals(Vilas.NUVEM)) {
            switch (idGraducao) {
                case 0:
                    return "Estudante";
                case 1:
        ...
        } else if (vila.equals(Vilas.AKATSUKI)) {
            switch (idGraducao) {
                case 0:
                    return "Fugitivo";
                case 1:
        ...
        } else if (vila.equals(Vilas.CHUVA)) {
            switch (idGraducao) {
                case 0:
                    return "Órfão";
                case 1:
