...
public class PersonagemLogadoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner channelSpinner = findViewById(R.id.chatChannerSpinner);
        ...
        buildMenu();
        expandableListView.setAdapter(new MenuPersonagemLogadoExpandableAdapter(PersonagemLogadoActivity.this, groupListText, groupListImage, childList));
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                if (groupPosition == GROUP_USUARIO) {
                    ...
                    switch (childPosition) {
                        case 0:
                            tituloSecao.setText("STATUS DO SEU PERSONAGEM");
    ...
    private void buildMenu() {
        groupListText = new ArrayList<>();
        groupListImage = new ArrayList<>();
