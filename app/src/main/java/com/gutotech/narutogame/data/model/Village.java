...
public enum Village implements Serializable {
    LEAF(R.string.leaf, R.string.hokage, R.drawable.layout_home_kages_1, R.drawable.layout_bandanas_1,
    ...
    SAND(R.string.sand, R.string.kazekage, R.drawable.layout_home_kages_2, R.drawable.layout_bandanas_2,
            R.drawable.layout_mapa_2, Arrays.asList(25, 54, 63, 68, 98),
            new int[]{Title.STUDENT.ordinal(), Title.GENIN.ordinal(), Title.CHUUNIN.ordinal(), Title.JOUNIN.ordinal(),
                    Title.ANBU.ordinal(), Title.SAND_SEALER.ordinal(), Title.HERO.ordinal()}),
    MIST(R.string.mist, R.string.mizukage, R.drawable.layout_home_kages_3, R.drawable.layout_bandanas_3,
            R.drawable.layout_mapa_3, Arrays.asList(42, 58, 81, 94, 98),
            new int[]{Title.STUDENT.ordinal(), Title.GENIN.ordinal(), Title.CHUUNIN.ordinal(), Title.JOUNIN.ordinal(),
                    Title.ANBU.ordinal(), Title.MIST_SWORDSMAN.ordinal(), Title.HERO.ordinal()}),
    STONE(R.string.stone, R.string.tsuchikage, R.drawable.layout_home_kages_4, R.drawable.layout_bandanas_4,
            R.drawable.layout_mapa_4, Arrays.asList(33, 62, 68, 85, 98),
            new int[]{Title.STUDENT.ordinal(), Title.GENIN.ordinal(), Title.CHUUNIN.ordinal(), Title.JOUNIN.ordinal(),
                    Title.ANBU.ordinal(), Title.STONE_HUNTER.ordinal(), Title.HERO.ordinal()}),
    CLOUD(R.string.cloud, R.string.raikage, R.drawable.layout_home_kages_5, R.drawable.layout_bandanas_5,
    ...
    SOUND(R.string.sound, R.string.otokage, R.drawable.layout_home_kages_7, R.drawable.layout_bandanas_7,
    ...
    RAIN(R.string.rain, R.string.amekage, R.drawable.layout_home_kages_8, R.drawable.layout_bandanas_8,
    ...
    SNOW(R.string.snow, 0, R.drawable.layout_home_kages_1, R.drawable.layout_bandanas_1,
            R.drawable.layout_map_9, Arrays.asList(56, 69, 73, 86, 98), null),
    WATERFALL(R.string.waterfall, 0, R.drawable.layout_home_kages_1, R.drawable.layout_bandanas_1,
            R.drawable.layout_map_10, Arrays.asList(55, 81, 88, 94, 101), null),
    HOT_SPRINGS(R.string.hot_springs, 0, R.drawable.layout_home_kages_1, R.drawable.layout_bandanas_1,
            R.drawable.layout_map_11, Arrays.asList(34, 58, 62, 65, 98), null),
    GRASS(R.string.grass, 0, R.drawable.layout_home_kages_1, R.drawable.layout_bandanas_1,
