...
public class ItemShopRecyclerAdapter extends RecyclerView.Adapter<ItemShopRecyclerAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        switch (itemShop.getTipoItem()) {
            case RAMEN:
                Storage.baixarRamenImage(context, myViewHolder.itemImageView, itemShop.getImage());
            ...
            case ARMA:
                ...
                if (arma.getAlcance() == Arma.Alcance.LONGO)
                    Storage.baixarArmaImage(context, myViewHolder.itemImageView, itemShop.getImage(), "longo");
                else
                    Storage.baixarArmaImage(context, myViewHolder.itemImageView, itemShop.getImage(), "curto");
                ...
                break;
            case PERGAMINHO:
                Storage.baixarPergaminhoImage(context, myViewHolder.itemImageView, itemShop.getImage());
                myViewHolder.itemImageView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                    }
