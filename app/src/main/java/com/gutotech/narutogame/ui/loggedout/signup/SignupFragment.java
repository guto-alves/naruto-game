...
public class SignupFragment extends Fragment implements AuthListener, SectionFragment {
    private FragmentSignupBinding binding;

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        SignupViewModel mRegistrationViewModel = ViewModelProviders.of(getActivity()).get(SignupViewModel.class);
        ...
        mRegistrationViewModel.setAuthListener(this);
